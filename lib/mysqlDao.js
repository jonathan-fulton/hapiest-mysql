...
class MysqlDao {
    ...
    */
    ...
    /**
     * Similar to leftJoin(), but will divide `objectsToJoin` into batches of size `maxBatchSize` for querying the database.
     * @param {object[]|object} objectsToJoin
     * @param {string} lookupKey
     * @param {int} [maxBatchSize = 100] - The max batch size for querying this Dao's table.
     * @param {object} options
